...
public class BulkOperationsApi: AdaptableApi {
	...
	public func getBulkOperations(currentPage: Int? = nil, pageSize: Int? = nil, withTotalElements: Bool? = nil) -> AnyPublisher<C8yBulkOperationCollection, Swift.Error> {
	...
	/// - Parameters:
	/// 	- body 
	public func createBulkOperation(body: C8yBulkOperation) -> AnyPublisher<C8yBulkOperation, Swift.Error> {
	...
	public func getBulkOperation(id: String) -> AnyPublisher<C8yBulkOperation, Swift.Error> {
		let builder = URLRequestBuilder()
	...
	/// 	- id 
	///		  Unique identifier of the bulk operation.
	public func updateBulkOperation(body: C8yBulkOperation, id: String) -> AnyPublisher<C8yBulkOperation, Swift.Error> {
		var requestBody = body
		requestBody.generalStatus = nil
		requestBody.failedParentId = nil
		requestBody.`self` = nil
	...
	/// 	- id 
	///		  Unique identifier of the bulk operation.
	public func deleteBulkOperation(id: String) -> AnyPublisher<Data, Swift.Error> {
		let builder = URLRequestBuilder()
			.set(resourcePath: "/devicecontrol/bulkoperations/\(id)")
