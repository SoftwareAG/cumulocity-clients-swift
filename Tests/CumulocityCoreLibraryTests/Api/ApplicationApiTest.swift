...
public class ApplicationApiTest: XCTestCase {
	
	class TestableApplicationApi: ApplicationApi {
	...
	public func testGetApplicationManagementApiResource() {
		let expectation = XCTestExpectation(description: "ok")
		var cancellables = Set<AnyCancellable>()
		try? TestableApplicationApi().getApplicationManagementApiResource().sink(receiveCompletion: { completion in
			print(completion)
