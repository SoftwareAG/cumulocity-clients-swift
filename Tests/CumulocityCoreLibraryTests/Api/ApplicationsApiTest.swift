...
public class ApplicationsApiTest: XCTestCase {
	
	class TestableApplicationsApi: ApplicationsApi {
	...
	public func testGetApplications() {
		...
		TestableApplicationsApi().getApplications().sink(receiveCompletion: { completion in
