...
public class PlatformApiTest: XCTestCase {
	
	class TestablePlatformApi: PlatformApi {
	...
	public func testGetPlatformApiResource() {
		let expectation = XCTestExpectation(description: "ok")
		var cancellables = Set<AnyCancellable>()
		try? TestablePlatformApi().getPlatformApiResource().sink(receiveCompletion: { completion in
			print(completion)
